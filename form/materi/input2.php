        ...
        <form action="proses2.php" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="number" name="bb" min="1" max="100" placeholder="Berat Badan">
                    <input type="number" name="tb" min="100" max="200" placeholder="Tinngi Badan">
                ...
                <tr>
                    ...
                    <th>:</th>
                    <td>
                        <input type="checkbox" name="sSehatt" id="" />Surat Sehat 
